...
| fahrschacht | `schiebetuer_2tlg` | „Schachtschiebetür 2-teilig“ (Oberbegriff je Haltestelle) | Kalkulatorischer Oberbegriff fuer die Schachtschiebetuer als Ganzes; die einzelnen Tuerkomponenten (`tuerfuehrungen`, `tuerlaufrollen`, `tuerkontakte`, `tuerseile`) haben bereits eigene, granulare LV-Positionen. Keine eigenstaendige LV-Position, um Kalkulationsstruktur nicht 1:1 in LV-Struktur zu spiegeln | Stk | – | – | – | eindeutig `not_lv_position` (2026-08-27) | `bestätigt` |
| fahrschacht | `demontage_schiebetuer_2tlg` | „Demontage Schachtschiebetür 2-teilig“ (lt. Components-Kalkulation) | Demontage der vorhandenen zweiflügeligen Schachtschiebetür je Tür | Stk | Demontage Schiebetür (2-tlg.) | `LV_05_01_DEMONTAGE_SCHIEBETUER_2TLG` | 1:1 | eindeutig | `bestätigt` |
| fahrschacht | `muz_standard` | „MUZ Standard“ | Lieferung und Montage von Mauerumfassungszargen je Schachtzugang; Abmessungen und Ausführung werden durch individuelles Aufmaß an jedem Schachtzugang bestimmt | Stk | Mauerumfassungszargen (individuelles Aufmaß) | `LV_11_27_MAUERUMFASSUNGSZARGEN_INDIVIDUELLES_AUFMASS` | 1:1 | eindeutig, neutral | `bestätigt` |
| fahrschacht | `zargenbeleuchtung` | „Zargenbeleuchtung“ | Integrierte LED-Beleuchtung beidseitig, ca. 25 cm über OKFF, einschließlich erforderlicher Anschlüsse und betriebsfertiger Montage | Stk | Zargenbeleuchtung | `LV_11_28_ZARGENBELEUCHTUNG` | 1:1 | eindeutig, neutral | `bestätigt` |
